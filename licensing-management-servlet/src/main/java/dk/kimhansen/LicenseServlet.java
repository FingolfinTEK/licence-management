...
public class LicenseServlet extends HttpServlet {
    ...
    @Inject private LicenseLookup licenseLookup;

    @Inject private EncryptLicenseKey encryptLicenseKey;

    @Inject private LicenseValidation licenseValidation;
    ...
    public String getEncryptedLicense(final LicenseInformation information) {
        try {
