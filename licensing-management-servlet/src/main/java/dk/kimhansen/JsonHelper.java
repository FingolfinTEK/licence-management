...
public class JsonHelper {
	...
	public static void writeLicenseInformationToJson(LicenseInformation found, JsonWriter writer) throws IOException {
		...
		writer.name(EXPIRE_TIMESTAMP).value(found.getExpireTimestamp().toString());
	...
	public static LicenseInformation readLicenseInformationFromJson(JsonObject object) {
	...
	public static String readEncryptedLicenceFromJson(JsonObject object) {
		String encryptedLicense = object.get(ENCRYPTED_LICENSE).getAsString();
		return encryptedLicense;
	}

	public static void wrtiteToJson(LicenseInformation found, String encryptedLicense, OutputStream outputStream) throws IOException {
